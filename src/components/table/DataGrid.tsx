import React, { useState, useMemo } from 'react';
    ...
    interface Column<T> {
      key: keyof T;
      header: string;
      sortable?: boolean; // Add a sortable flag
    }

    export function DataGrid<T extends Record<string, any>>({ data, columns, defaultSortKey }: DataGridProps<T>) {
      ...
      const sortedData = useMemo(() => {
        ...
        return [...data].sort((a, b) => {
          ...
          if (aValue === null || aValue === undefined) return 1;  // Handle null/undefined
